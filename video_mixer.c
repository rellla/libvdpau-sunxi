...
static void set_csc_matrix(mixer_ctx_t *mix, VdpColorStandard standard)
{
	...
	VDPAU_LOG(LDBG, "Setting mixer value from following color standard: %d", standard);
	VDPAU_LOG(LDBG, ">mix->bright: %2.3f, mix->contrast: %2.3f, mix->saturation: %2.3f, mix->hue: %2.3f",
                                  ...
                                  VdpCSCMatrix *csc_matrix)
{
	...
	VDPAU_LOG(LDBG, "Generate CSC matrix from following color standard: %d", standard);
	VDPAU_LOG(LDBG, ">procamp->bright: %2.3f, procamp->contrast: %2.3f, procamp->saturation: %2.3f, procamp->hue: %2.3f",
